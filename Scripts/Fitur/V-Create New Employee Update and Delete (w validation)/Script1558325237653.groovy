...
while (WebUI.verifyElementPresent(findTestObject('Object Repository/Vendor/Menu Employee/popUpValidation'), 4, FailureHandling.OPTIONAL)){
	if (WebUI.getAttribute(findTestObject('Vendor/Menu Employee/txtNamaEmp'), 'value') == ''){
		WebUI.setText(findTestObject('Vendor/Menu Employee/txtNamaEmp'), (nama_employee + '-') + rnd_nama)
	}
	else if (WebUI.getAttribute(findTestObject('Vendor/Menu Employee/txtEmailEmp'), 'value', FailureHandling.OPTIONAL) == ''){
		WebUI.setText(findTestObject('Vendor/Menu Employee/txtEmailEmp'), (nama_employee + rnd_nama) + '@gmail.com')
	}
	else if (WebUI.getAttribute(findTestObject('Vendor/Menu Employee/txtNoTelp'), 'value') == ''){
		WebUI.setText(findTestObject('Vendor/Menu Employee/txtNoTelp'), no_telp, FailureHandling.OPTIONAL)
	}
	else if (WebUI.getAttribute(findTestObject('Vendor/Menu Employee/lstTypeEmp'), 'value') == ''){
