...
while (WebUI.verifyElementPresent(findTestObject('Object Repository/Satker/Menu Vendor/popUpAddFailed'), 4)){
	if (WebUI.getAttribute(findTestObject('Object Repository/Satker/Menu Vendor/txtIdDistributor'), 'value') == ''){
		'Input ID Distributor'
		WebUI.setText(findTestObject('Satker/Menu Vendor/txtIdDistributor'), id_distributor + ('-' + rnd_iddistributor))
	}
	else if (WebUI.getAttribute(findTestObject('Object Repository/Satker/Menu Vendor/txtNikSiup'), 'value') == ''){
		'Input NIK/SIUP'
		WebUI.setText(findTestObject('Object Repository/Satker/Menu Vendor/txtNikSiup'), rnd_iddistributor + '/' + 000  + '-01.' + '1')
	}
	else if (WebUI.getAttribute(findTestObject('Object Repository/Satker/Menu Vendor/txtNpwp'), 'value', FailureHandling.OPTIONAL) == ''){
		rnd_npwp = RandStr.randomNumeric(12)
		'Input NPWP'
		WebUI.setText(findTestObject('Object Repository/Satker/Menu Vendor/txtNpwp'), rnd_npwp + '001')
	}
	else if (WebUI.getAttribute(findTestObject('Object Repository/Satker/Menu Vendor/txtNamaDistributor'), 'value', FailureHandling.OPTIONAL) == ''){
	...
	else if (WebUI.getAttribute(findTestObject('Object Repository/Satker/Menu Vendor/txtEmailDistributor'), 'value') == ''){
		'Input email distributor'
		WebUI.setText(findTestObject('Satker/Menu Vendor/txtEmailDistributor'), (id_distributor + ('.' + rnd_iddistributor)) + '@gmail.com', FailureHandling.OPTIONAL)
	}
	else if (WebUI.getAttribute(findTestObject('Object Repository/Satker/Menu Vendor/txtNoTelpDistributor'), 'value') == ''){
		'Input nomor telepon'
		WebUI.setText(findTestObject('Satker/Menu Vendor/txtNoTelpDistributor'), no_telp + rnd_notelp)
	}
	else if (WebUI.getAttribute(findTestObject('Object Repository/Satker/Menu Vendor/txtNoRekBRI'), 'value') == ''){
		'Input no rek BRI distributor'
		WebUI.setText(findTestObject('Satker/Menu Vendor/txtNoRekBRI'), norek_bri)
	}
	else if (WebUI.getAttribute(findTestObject('Object Repository/Satker/Menu Vendor/txtAlamatDistributor'), 'value') == ''){
