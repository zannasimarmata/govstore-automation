...
CustomKeywords.'common.login.loginPKN'()

WebUI.click(findTestObject('Object Repository/Admin/Left Menu/List KPPN'))
...
//WebUI.setText(findTestObject('Object Repository/General/txtSearch'), 'jono')

//WebUI.click(findTestObject('Object Repository/General/btnEdit'))

//WebUI.setText(findTestObject('Object Repository/Admin/List PKN/txtEditUsername'), username)
