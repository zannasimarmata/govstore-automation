...
WebUI.click(findTestObject('Object Repository/Pengadaan/List Pengajuan/btnApproveOrder'))

'Verify if Payment Method pop up appear'
WebUI.verifyElementPresent(findTestObject('Object Repository/Pengadaan/List Pengajuan/popUpPaymentMethod'), 4)

'Click drop down to select method payment'
WebUI.click(findTestObject('Object Repository/Pengadaan/List Pengajuan/lstPaymentMethod'))

'Select Payment method that will be used'
WebUI.selectOptionByValue(findTestObject('Object Repository/Pengadaan/List Pengajuan/lstPaymentMethod'), '1', true)

'Click button Approve to process order'
WebUI.click(findTestObject('Object Repository/Pengadaan/List Pengajuan/btnApprovePayment'))
...
'Verify the invoice should not exist'
...
'Verify the status, should be \'Order Diteruskan Ke Vendor\''
WebUI.verifyMatch(WebUI.getText(findTestObject('Object Repository/Pengadaan/Status Proses Pengajuan/lblStatusOrder')), 'Order Diteruskan Ke Vendor', true)
